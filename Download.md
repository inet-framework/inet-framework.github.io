...
<a class="btn btn-primary" href="https://github.com/inet-framework/inet/releases/download/v3.2.1/inet-3.2.1-src.tgz">Download latest stable version (3.2.1, for OMNeT++ 4.6 and later)</a> ([What's New](https://github.com/inet-framework/inet/blob/v3.2.1/WHATSNEW))
