...
<p><pre class="snippet" src="Snippets.cc" after="//!UdpSocketCallbackInterfaceExample" until="//!End"></pre>
...
<p><pre class="snippet" src="Snippets.cc" after="//!TcpSocketCallbackInterfaceExample" until="//!End"></pre>
...
<p><pre class="snippet" src="Snippets.cc" after="//!Ipv4SocketCallbackInterfaceExample" until="//!End"></pre>
<p>For example, the application may directly implement the
...
<p><pre class="snippet" src="Snippets.cc" after="//!Ipv6SocketCallbackInterfaceExample" until="//!End"></pre>
<p>For example, the application may directly implement the
...
<p><pre class="snippet" src="Snippets.cc" after="//!L3SocketCallbackInterfaceExample" until="//!End"></pre>
<p>For example, the application may directly implement the
